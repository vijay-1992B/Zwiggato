  ...
  return (
    ...
    <div className="pl-2 py-3">
      <div className="flex justify-between text-center">
        <h4 className="font-bold text-[16px] lg:text-[18px] text-start">{name}</h4>
        <h4 className="font-semibold text-[16px] lg:text-[18px]">
          {avgRatingString}
          <i className="ri-star-fill text-[#14883f] text-[15px] lg:text-[18px] pl-2 align-top"></i>
        </h4>
      </div>
